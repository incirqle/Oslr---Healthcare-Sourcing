/**
 * search-clinicians/index.ts — Oslr's clinical people-search engine.
 *
 ...
 * imports from ../pdl-search, ../_shared, or any other engine, and no other
 * engine may import from here.
 *
